# Django settings for socialbum project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('fattyice', 'fattyice@gmail.com'),
)
...
SECRET_KEY = 'f%v&(5%1#&5th^m*fwn&37180iuv8ej!v!e#e5d&%#(h&kw3(7'
...
ROOT_URLCONF = 'socialbum.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'socialbum.wsgi.application'
